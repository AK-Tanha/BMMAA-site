...
export default function HeroSection({
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-16 md:pt-20">
      ...
      <svg className="absolute top-8 right-8 w-32 h-32 text-secondary-500/40 pointer-events-none" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className="absolute bottom-8 left-8 w-32 h-32 text-secondary-500/40 pointer-events-none rotate-180" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M90 10V60C90 76.5685 76.5685 90 60 90H10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M70 10H90V30" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
      ...
      <div className="relative z-10 text-center text-white px-4 md:px-8 max-w-4xl flex-1 flex flex-col items-center justify-center">
        <p className="animate-fade-in text-sm md:text-base font-bold uppercase tracking-[0.25em] text-secondary-400 mb-4">
          {ORGANIZATION.shortName}
        </p>
        <h1 className="animate-slide-up text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
          {title}
        </h1>
        <p className="animate-fade-in animate-delay-200 text-lg md:text-xl text-white/70 mb-8 max-w-2xl mx-auto leading-relaxed">
          {subtitle}
        </p>

        <div className="animate-slide-up animate-delay-300 flex flex-col md:flex-row gap-4 justify-center">
