          ...
          {features.map((feature) => {
            ...
            return (
              <a
                key={feature.title}
                href={feature.href}
                className="group bg-white rounded-xl p-8 shadow-card border border-neutral-100 hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <h3 className="text-xl font-bold text-neutral-900 mb-2 font-heading">{feature.title}</h3>
